...
\question[3]
Benenne die restlichen Winkel, Kanten und Ecken des Dreiecks auf korrekte Weise.\bigskip 
...
\question[3]
Finde die rechtwinkligen Dreiecke. Markiere den rechten Winkel und die Hypothenuse. \hier
...
\begin{parts}
    \part[1] Kreuze die richtige Formel für die Berechnung der \textbf{Hypothenusenlänge} an. \hier
...
\begin{minipage}[b]{0.45 \textwidth}
    ...
    \end{align*}
    \part[2]
Berechne den Abstand der Punkte A und B. \droppoints
    \end{parts}
\end{minipage}
...
\begin{minipage}{0.65 \textwidth}
    ...
    \begin{parts}
    \part[2] Zeige durch Rechnung, dass der Winkel in Punkt A ein rechter Winkel ist. \droppoints
    \part[2] Zeige durch Rechnung, dass der Winkel in Punkt C kein rechter Winkel ist. \droppoints
    \end{parts}
\end{minipage}
